...
.printReference <- function(file){
  ...
  kable( t(as.matrix(ref)) , digits=10,  caption = "Reference" )
}

.printOverall <- function(file){
  overall <- read.xlsx( file, sheetIndex=2, header=TRUE )
  kable(t( overall ), digits=10, caption = "Overall Statistics" )
}
...
![Fig. Example IGR = 0.88](assets/img/imp_varRF.png)
```{r echo=F}
if (switch_activity == 1){
...
```
![Fig. Example IGR = 0.88](assets/img/imp_varIGR.png)
